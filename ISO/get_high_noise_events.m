...
function [ res,  noiseInx] =  get_high_noise_events(analog, apIndex,threshold)
...
commonVals =[];
for i = -2:2
    commonVals = [commonVals intersect(eventInx, apIndex+ i)];
end
noiseInx = setdiff(eventInx,commonVals );
